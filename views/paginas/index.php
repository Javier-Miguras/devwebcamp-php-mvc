...
<section class="resumen">
    <div class="resumen__grid">
        <div data-aos-once="true" <?php aos_animation(); ?> class="resumen__bloque">
...
<section class="speakers">
    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente): ?>
            <div data-aos-once="true" <?php aos_animation(); ?> class="speaker">
                <picture>
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div data-aos-once="true" <?php aos_animation(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$199</p>
        </div>
        <div data-aos-once="true" <?php aos_animation(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$49</p>
        </div>
        <div data-aos-once="true" <?php aos_animation(); ?> class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
