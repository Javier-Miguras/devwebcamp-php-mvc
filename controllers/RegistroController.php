...
class RegistroController{
    public static function crear(Router $router){
        ...
        //Verificar si usuario ya está registrado
    ...
    public static function gratis(){
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            $token = substr(md5(uniqid(rand(), true)), 0, 8); //substr corta la longitud del token desde el inicio hasta 8 caracteres
    ...
    public static function conferencias(Router $router){
        ...
        //Manejando el registro con $_POST
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
