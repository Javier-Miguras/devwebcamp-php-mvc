(function(){
    ...
    if(horas){
        ...
        function obtenerHorasDisponibles(eventos){
            ...
            //Comprobar eventos disponibles y quitarles la variable deshabilitado
            const horasTomadas = eventos.map(evento => evento.hora_id);

            //convertir nodelist a array
            const listadoHorasArray = Array.from(listadoHoras);

            //filtrar las horas tomadas
            const resultado = listadoHorasArray.filter(li => !horasTomadas.includes(li.dataset.horaId));

            //Quitar clase deshabilitada a horas disponibles
        ...
        function seleccionarHora(e){
            ...
            //Agregar value con id hora a input oculto
